# Развертывание Windows Server 2022 и настройка первого доменного контроллера Active Directory

В этой инструкции мы развернем Windows Server 2022 и настроим его как первый контроллер домена. Контроллер домена управляет сетевой инфраструктурой, обеспечивая безопасный доступ и хранение данных о пользователях, группах, компьютерах и других устройствах. 
